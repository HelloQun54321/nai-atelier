      ...
      <div className="mx-auto flex min-h-0 w-full max-w-[1920px] flex-1 flex-col">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-3 md:p-5">
          {filteredChains.length === 0 ? (
            ...
            /* Grid Layout */
            <>
            <div className={`${mobileGalleryClassName(imageDisplay)} workspace-card-grid workspace-chain-grid mobile-gallery-flow`} style={mobileGalleryStyle(imageDisplay, visibleChains.length)}>
