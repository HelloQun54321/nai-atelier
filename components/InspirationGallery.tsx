  ...
  return <div className="flex min-h-0 flex-1 flex-col bg-gray-50 dark:bg-gray-950">
    ...
    <div className="flex min-h-0 flex-1">
      ...
      <main className="min-w-0 flex-1 overflow-y-auto">
        ...
        {filtered.length > 0 ? <div className={`${mobileGalleryClassName(imageDisplay)} p-3 md:grid md:grid-cols-3 md:gap-4 md:p-5 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6`} style={mobileGalleryStyle(imageDisplay)}>
          {filtered.map(item => {
