  ...
  return (
    <div className="relative flex h-full min-h-0 flex-1 flex-col overflow-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div ref={scrollRef} className="relative flex-1 overflow-y-auto p-4 pb-28 md:p-6 md:pb-24">
        ...
        <div className={`${mobileGalleryClassName(imageDisplay)} workspace-card-grid workspace-character-grid`} style={{ ...mobileGalleryStyle(imageDisplay, visibleCards.length), ...(isMobileViewport ? {} : { '--mobile-gallery-columns': gridColumns }) }}>
