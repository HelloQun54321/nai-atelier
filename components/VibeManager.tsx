    ...
    <>
      <div>
        <div className="flex items-center justify-between gap-3">
          ...
          <button type="button" onClick={() => setOpen(true)} className="mobile-touch flex-none rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-bold text-indigo-600 hover:bg-indigo-50 dark:border-gray-700 dark:bg-gray-900 dark:text-indigo-300">管理</button>
        </div>
      </div>
      ...
      {open && <div className="workspace-manager fixed inset-0 z-[1100] flex flex-col bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-100">
        ...
        {detail ? <main className="flex-1 overflow-y-auto p-4 md:p-6">
          ...
          <div className="flex flex-none flex-wrap items-center gap-2 border-b border-gray-200 bg-white p-3 dark:border-gray-800 dark:bg-gray-900 md:px-5">
            <div className="relative min-w-[180px] flex-1"><input value={search} onChange={event => setSearch(event.target.value)} placeholder="搜索我的 Vibe" className="mobile-touch w-full rounded-xl border border-gray-200 bg-gray-50 px-4 text-sm outline-none focus:border-violet-500 dark:border-gray-800 dark:bg-gray-950" /></div>
          ...
          <main className="workspace-manager-split grid min-h-0 flex-1 md:grid-cols-[minmax(0,1fr)_360px]">
