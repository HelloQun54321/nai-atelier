                    ...
                    <>
                        <div className="space-y-6">
                          {historyGroups.map(group => <section key={group.key}>
                            ...
                            <div className={`${mobileGalleryClassName(imageDisplay)} workspace-card-grid workspace-history-grid mobile-gallery-flow`} style={mobileGalleryStyle(imageDisplay, group.items.length)}>
