...
export const PromptAgentSettings: React.FC<PromptAgentSettingsProps> = ({ notify }) => {
  ...
  return <>
    ...
    {view !== 'home' && <div className="fixed inset-0 z-[1700] flex flex-col bg-gray-50 dark:bg-gray-950">
      <header className="workspace-command-bar flex h-16 flex-none items-center gap-3 border-b border-gray-200 bg-white px-3 dark:border-gray-800 dark:bg-gray-900 md:px-5">
