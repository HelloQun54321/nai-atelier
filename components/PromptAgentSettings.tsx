        ...
        <div className={`min-w-0 space-y-4 w-full ${mobileTab === 'editor' ? 'block' : 'hidden md:block'}`}>
          ...
          {inspectorOpen && (
            <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mb-2 rounded-lg bg-indigo-50 px-2.5 py-1.5 text-micro leading-4 text-indigo-700 dark:bg-indigo-950/30 dark:text-indigo-300">Pi 规范化上下文估算（非供应商 wire payload）：展示经注入拼装后的 systemPrompt 与规范化消息序列，供核对上下文构成与占用。</p>
