...
export const ImageEditCanvas: React.FC<ImageEditCanvasProps> = ({
  ...
  if (isFullscreen) {
    return (
      <>
        {/* 全屏模态背景遮罩 */}
        <div className="fixed inset-0 z-[950] flex flex-col bg-gray-950/90 p-4 backdrop-blur-md sm:p-6">
          <div className="mb-3 flex items-center justify-between gap-3 text-white">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[11px] text-gray-400 hidden sm:inline">按住空格或中键拖拽平移 · Ctrl+滚轮缩放</span>
              <button
                type="button"
        ...
        {/* 占位元素保持原布局高度 */}
        <div className="h-[300px] w-full rounded-xl border border-dashed border-gray-200 bg-gray-50/50 dark:border-gray-800 dark:bg-gray-900/30 flex items-center justify-center text-xs text-gray-400">
          全屏精修中...
        </div>
      </>
    );
