...
export const WorkspaceToolbar: React.FC<{
  ...
  <header className={`workspace-page-heading workspace-command-bar relative z-30 flex h-16 flex-none items-center gap-2 overflow-visible border-b border-gray-200 bg-white px-3 py-0 dark:border-gray-800/80 dark:bg-gray-900/90 md:px-5 ${className}`}>
    {children}
  </header>
);
