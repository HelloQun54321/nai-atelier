...
- 画师 Tag 没有本地图片时按需使用精确 Tag 下的最高分作品；角色会先排除多人图、漫画、文字梗、玩偶、特殊服装等干扰，再统计候选中常见的发型、饰品与服装 Tag，优先选择最接近典型外观的清晰单人图，热度只作为次级排序。老师、提督等没有可靠单人形象的泛角色宁可留空，不强行误配；结果缓存 14 天，已有本地封面始终优先。
