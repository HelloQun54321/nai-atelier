<div align="center">
  ...
  **面向 NovelAI 的个人本地创作工坊**
  ...
  [![Version](https://img.shields.io/badge/version-0.150.12-6366f1?style=flat-square)](./CHANGELOG.md)
...
- 可以搜索本地中英 Tag、风格串、自定义角色、画师资料、灵感、AITag、永久 Vibe、角色参考与组合，并创建或更新相应的项目资料。
...
- Agent 每次需要预设时先搜索轻量摘要，再按 ID 读取单条风格串或自定义角色的完整模块、参数、Vibe 与角色参考快照；局部修改会与原参数合并，不会因为只改步数而清空尺寸、采样器或高级引用。Vibe 由工具按 ID 查询电脑资料库，浏览器不再在每条消息里重复上传整批预设和 Vibe。
